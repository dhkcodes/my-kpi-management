...
assert.match(content, /activeRoute\.module === "myCustomers360"[\s\S]*accountsWorkloadsLoading \?[\s\S]*aria-label="Loading Account Portfolio"[\s\S]*Loading Account Portfolio data/, "Account Portfolio mirrors the Accounts & Workloads full-page loading state");
