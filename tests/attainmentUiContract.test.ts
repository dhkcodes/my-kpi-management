...
assert.match(pageSource, /DP Forecast/);
assert.match(pageSource, /OCI Actual/);
assert.match(pageSource, /OCI Forecast/);
assert.match(pageSource, /Budget marker/i, "the DP/OCI Actual/Forecast composition chart names its Budget marker");
assert.match(pageSource, /Remaining Target/);
assert.match(pageSource, /Required Monthly Average/);
assert.match(pageSource, /FY Complete/);
assert.match(pageSource, /current month is included/i, "the approved remaining-month policy is visible");
